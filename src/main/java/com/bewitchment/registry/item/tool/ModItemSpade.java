...
{
	public ModItemSpade(String name, CreativeTabs tab, ToolMaterial mat)
	{
		super(mat);
	...
	public static class ColdIron extends ModItemSpade
	{
	...
	public static class Silver extends ModItemSpade
	{
