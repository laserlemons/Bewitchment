...
public class BlockDropHandler
{
	...
	public void harvestDrops(HarvestDropsEvent event)
	{
		...
		replaceDrop(event, ModBlocks.leaves_juniper, new ItemStack(ModItems.juniper_berries), 15, false, true);
		replaceDrop(event, ModBlocks.leaves_yew, new ItemStack(ModItems.yew_aril), 15, false, true);
	}
